...
from Altron import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Altron.__main__ import DATA_IMPORT
from Altron.modules.helper_funcs.chat_status import user_admin
from Altron.modules.helper_funcs.alternate import typing_action

# from Altron.modules.rules import get_rules
import Altron.modules.sql.rules_sql as rulessql

# from Altron.modules.sql import warns_sql as warnssql
import Altron.modules.sql.blacklist_sql as blacklistsql
from Altron.modules.sql import disable_sql as disabledsql

# from Altron.modules.sql import cust_filters_sql as filtersql
# import Altron.modules.sql.welcome_sql as welcsql
import Altron.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("Altron{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Altron{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Altron-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Altron{}.backup".format(chat_id))  # Cleaning file
